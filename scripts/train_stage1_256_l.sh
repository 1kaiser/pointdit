...
# Stage 1: PointDiT-L pre-training at 256x256 on SceneNet-RGBD.
# Original run: 16 GPUs x batch 64 (effective batch 1024, lr 2e-4), 30 epochs.
...
OUTPUT_DIR=checkpoints/pointdit-l-256
mkdir -p ${OUTPUT_DIR}
