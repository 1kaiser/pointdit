...
# Stage 1: PointDiT-B pre-training at 256x256 on SceneNet-RGBD.
# Original run: 16 GPUs x batch 256 (effective batch 4096, lr 8e-4), 30 epochs.
# lr = blr * batch_size * num_gpus / 256, so keep that product at 4096 or pass --lr.
...
OUTPUT_DIR=checkpoints/pointdit-b-256
mkdir -p ${OUTPUT_DIR}
